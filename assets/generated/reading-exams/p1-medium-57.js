(function registerReadingExamData(global) {
  ...
  "questionGroups": [
    ...
    },
    {
      ...
      "bodyHtml": "<div class=\"group\" id=\"q9-10-anchor\">\n                <h4>Questions 9 and 10</h4>\n                <p>Choose <strong>TWO</strong> letters, <strong>A–E</strong>.</p>\n                <p>Which <strong>TWO</strong> of the following are mentioned by the writer as advantages of blockbusters?</p>\n                <div class=\"checkbox-options\">\n                    <div class=\"choice-item\"><label><input type=\"checkbox\" name=\"q9_10\" value=\"A\"> <strong>A</strong> Some of the money they raise can be used for structural repairs.</label></div>\n                    <div class=\"choice-item\"><label><input type=\"checkbox\" name=\"q9_10\" value=\"B\"> <strong>B</strong> They can provide funds to help support amateur artists.</label></div>\n                    <div class=\"choice-item\"><label><input type=\"checkbox\" name=\"q9_10\" value=\"C\"> <strong>C</strong> Local services benefit from the extra business they bring about.</label></div>\n                    <div class=\"choice-item\"><label><input type=\"checkbox\" name=\"q9_10\" value=\"D\"> <strong>D</strong> They encourage overseas workers into the local area.</label></div>\n                    <div class=\"choice-item\"><label><input type=\"checkbox\" name=\"q9_10\" value=\"E\"> <strong>E</strong> They raise employee performance levels.</label></div>\n                </div>\n            </div>"
    },
    {
      "groupId": "group-4",
      "kind": "multi_choice",
      ...
      "bodyHtml": "<div class=\"group\" id=\"q11-13-anchor\">\n                <h4>Questions 11–13</h4>\n                <p>Choose <strong>THREE</strong> letters, <strong>A–G</strong>.</p>\n                <p>Which <strong>THREE</strong> of the following are mentioned by the writer as disadvantages of blockbusters?</p>\n                 <div class=\"checkbox-options\">\n                    <div class=\"choice-item\"><label><input type=\"checkbox\" name=\"q11\" value=\"A\"> <strong>A</strong> They do not suit museum management styles.</label></div>\n                    <div class=\"choice-item\"><label><input type=\"checkbox\" name=\"q11\" value=\"B\"> <strong>B</strong> Specialist business advice has to be paid for.</label></div>\n                    <div class=\"choice-item\"><label><input type=\"checkbox\" name=\"q11\" value=\"C\"> <strong>C</strong> They involve an increased workload for personnel.</label></div>\n                    <div class=\"choice-item\"><label><input type=\"checkbox\" name=\"q11\" value=\"D\"> <strong>D</strong> They do not increase overall annual visitor numbers.</label></div>\n                    <div class=\"choice-item\"><label><input type=\"checkbox\" name=\"q11\" value=\"E\"> <strong>E</strong> They are very tiring to put on.</label></div>\n                    <div class=\"choice-item\"><label><input type=\"checkbox\" name=\"q11\" value=\"F\"> <strong>F</strong> What is popular in one country may not be popular in another.</label></div>\n                    <div class=\"choice-item\"><label><input type=\"checkbox\" name=\"q11\" value=\"G\"> <strong>G</strong> The content can be weakened through financial pressure.</label></div>\n                </div>\n            </div>"
    }
  ],
  "answerKey": {
    "q1": "C",
