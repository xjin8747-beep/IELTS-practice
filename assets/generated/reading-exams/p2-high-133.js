(function registerReadingExamData(global) {
  ...
  "questionGroups": [
    ...
    },
    {
      ...
      "bodyHtml": "<div class=\"group\" id=\"q7-8-anchor\">\n                <h4>Questions 20 and 21</h4>\n                <p>Choose <strong>TWO</strong> letters, <strong>A–E</strong>.</p>\n                <p>The list below gives some possible reasons for the popularity of street soccer. Which <strong>TWO</strong> of these reasons are mentioned by the writer of the text?</p>\n                <div class=\"checkbox-group\">\n                    <div class=\"choice-item\"><label><input type=\"checkbox\" name=\"q7-8\" value=\"A\"> A Many famous soccer players got their start in street soccer.</label></div>\n                    <div class=\"choice-item\"><label><input type=\"checkbox\" name=\"q7-8\" value=\"B\"> B Young people can begin playing street soccer at a very early age.</label></div>\n                    <div class=\"choice-item\"><label><input type=\"checkbox\" name=\"q7-8\" value=\"C\"> C You do not need elaborate facilities to play street soccer.</label></div>\n                    <div class=\"choice-item\"><label><input type=\"checkbox\" name=\"q7-8\" value=\"D\"> D Inexperienced street soccer players are not criticised for mistakes.</label></div>\n                    <div class=\"choice-item\"><label><input type=\"checkbox\" name=\"q7-8\" value=\"E\"> E Street soccer teams can have varying numbers of players.</label></div>\n                </div>\n            </div>"
    },
    {
      "groupId": "group-3",
      "kind": "multi_choice",
      ...
      "bodyHtml": "<div class=\"group\" id=\"q9-10-anchor\">\n                <h4>Questions 22 and 23</h4>\n                <p>Choose <strong>TWO</strong> letters, <strong>A–E</strong>.</p>\n                <p>The list below gives some possible results of the 1960s parenting style. Which <strong>TWO</strong> of these results are mentioned by Franklin Foer in the excerpt from How Soccer Explains the World?</p>\n                 <div class=\"checkbox-group\">\n                    <div class=\"choice-item\"><label><input type=\"checkbox\" name=\"q9-10\" value=\"A\"> A Participation in youth soccer became much more expensive.</label></div>\n                    <div class=\"choice-item\"><label><input type=\"checkbox\" name=\"q9-10\" value=\"B\"> B Some youth soccer leagues adopted more restrictive rules of play.</label></div>\n                    <div class=\"choice-item\"><label><input type=\"checkbox\" name=\"q9-10\" value=\"C\"> C Fewer young people joined youth soccer teams.</label></div>\n                    <div class=\"choice-item\"><label><input type=\"checkbox\" name=\"q9-10\" value=\"D\"> D Youth soccer players were sometimes rewarded for simply playing in games.</label></div>\n                    <div class=\"choice-item\"><label><input type=\"checkbox\" name=\"q9-10\" value=\"E\"> E Soccer equipment manufacturers directed advertising towards parents.</label></div>\n                </div>\n            </div>"
    },
    {
      "groupId": "group-4",
