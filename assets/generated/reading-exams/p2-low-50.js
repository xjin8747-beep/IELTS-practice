(function registerReadingExamData(global) {
  ...
  "questionGroups": [
    ...
    },
    {
      ...
      "bodyHtml": "<div class=\"group\" id=\"q5-6-anchor\">\n                <h4>Questions 18 and 19</h4>\n                <p>Choose <strong>TWO</strong> letters, <strong>A–E</strong>.</p>\n                <p>The list below gives some effects that jellyfish have had on the world. Which <strong>TWO</strong> of these effects are mentioned by the writer of the text?</p>\n                <div class=\"checkbox-group\">\n                    <div class=\"choice-item\"><label><input type=\"checkbox\" name=\"q5-6\" value=\"A\"> A They have damaged the tourism industry in some areas.</label></div>\n                    <div class=\"choice-item\"><label><input type=\"checkbox\" name=\"q5-6\" value=\"B\"> B They have led to a reduction in the oceans' oxygen levels.</label></div>\n                    <div class=\"choice-item\"><label><input type=\"checkbox\" name=\"q5-6\" value=\"C\"> C They have contributed to the decline in the Black Sea anchovy population.</label></div>\n                    <div class=\"choice-item\"><label><input type=\"checkbox\" name=\"q5-6\" value=\"D\"> D They have caused the shrimp business in the Gulf of Mexico to shut down.</label></div>\n                    <div class=\"choice-item\"><label><input type=\"checkbox\" name=\"q5-6\" value=\"E\"> E They have created financial hardship in the fishing industry.</label></div>\n                </div>\n            </div>"
    },
    {
      "groupId": "group-3",
      "kind": "multi_choice",
      ...
      "bodyHtml": "<div class=\"group\" id=\"q7-8-anchor\">\n                <h4>Questions 20 and 21</h4>\n                <p>Choose <strong>TWO</strong> letters, <strong>A–E</strong>.</p>\n                <p>Which <strong>TWO</strong> of the following are possible causes of an increase in jellyfish numbers?</p>\n                 <div class=\"checkbox-group\">\n                    <div class=\"choice-item\"><label><input type=\"checkbox\" name=\"q7-8\" value=\"A\"> A a shortage of small fish in the oceans</label></div>\n                    <div class=\"choice-item\"><label><input type=\"checkbox\" name=\"q7-8\" value=\"B\"> B the dumping of chemicals into the oceans</label></div>\n                    <div class=\"choice-item\"><label><input type=\"checkbox\" name=\"q7-8\" value=\"C\"> C a decline in biodiversity in the oceans</label></div>\n                    <div class=\"choice-item\"><label><input type=\"checkbox\" name=\"q7-8\" value=\"D\"> D more competition among other fish in the oceans</label></div>\n                    <div class=\"choice-item\"><label><input type=\"checkbox\" name=\"q7-8\" value=\"E\"> E a decrease in seabird populations</label></div>\n                </div>\n            </div>"
    },
    {
      "groupId": "group-4",
